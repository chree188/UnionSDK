package suningnetallianceinverstmentcommodityquery
...
type SnBody struct {
	QueryInverstmentcommodity []QueryInverstmentcommodity `json:"queryInverstmentcommodity"`
}

type QueryInverstmentcommodity struct {
